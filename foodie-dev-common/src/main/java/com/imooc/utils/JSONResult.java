...
public class JSONResult {
    ...
    public static JSONResult error(FoodieExceptionEnum foodieExceptionEnum) {
        return new JSONResult(foodieExceptionEnum.getStatus(), foodieExceptionEnum.getMsg(), null);
    }
