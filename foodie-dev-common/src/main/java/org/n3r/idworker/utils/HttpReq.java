...
public class HttpReq {
  ...
  public String exec() {
    ...
    try {
      ...
      if (status == 200) {
        ...
        logger.warn(
          "non 200 respoonse :" + readErrorResponseBody(http, status, charset)
        );
        return null;
      }
    } catch (Exception e) {
  ...
  private static String readErrorResponseBody(
  ...
  private static String toString(String charset, InputStream inputStream)
    throws IOException {
